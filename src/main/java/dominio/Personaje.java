...
public abstract class Personaje extends MadreDeTodo
    ...
    public static void cargarTablaNivel() {
        ...
        for (int i = 2; i < CANTIDAD_NIVELES; i++) {
            Personaje.getTablaDeNiveles()[i] = Personaje.getTablaDeNiveles()[i
                    - 1] + CONSTANTE_NIVEL;
        }
    }
    ...
    public final int atacar(final Peleable atacado) {
        ...
        if (atacado.getSalud() > 0) {
            if (this.getRandom()
                    .nextDouble() <= this.casta.getProbabilidadGolpeCritico()
    ...
    /**
     * Indica si el personaje tiene enrgía mínima disponible para realizar un
     * ataque. <br>
     *
     ...
     * <p>
     * Si los puntos de stats del personaje no fueron modificados, los atributos
     * permanecen igual. <br>
     */
     ...
     * <p>
     * Mientras no se haya llegado al máximo nivel, se reinicia la experiencia.
     * <br>
     */
    public final void subirNivel() {
        ...
        while (this.getNivel() != NIVEL_MAXIMO && (this.experiencia >= Personaje
     ...
     *            <i><u>Nota</u>: Puede no ser requerido según la habilidad.</i>
     *            <br>
    ...
    public final void actualizarAtributos(final HashMap<String, Number> map) {
        ...
        casta.setProbabilidadEvitarDano(
